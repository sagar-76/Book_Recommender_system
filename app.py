...
#     try:
#         # Find the index of the book_name
...
#
#         # Print the names of similar items
#         data = []
#         for i in similar_items:
#             #             print(pt.index[i[0]])
#             item = []
#             temp_df = books[books['Book-Title'] == pt.index[i[0]]]
#             # this wil return index of that book
...
#
#     except IndexError:
#         print("Book not found or insufficient data for recommendations.")
#
#     # Call the recommend function with a book name
#
#     # see ye authorka naam bhi de rha hai
#
#
#
#
